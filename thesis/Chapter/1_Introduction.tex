...
Luận văn này gọi khoảng cách đó là khoảng cách thực thi chính sách bảo mật (enforcement gap):
...
Từ các bảng so sánh trên, khoảng trống chính nằm ở việc kết nối hai nhóm
...
\subsection{Hình thức hóa bài toán}
\label{subsec:formal}
...
trạng thái vào vùng từ chối, hoặc ít nhất là đưa vào các trạng thái
biên (edge states) để kích hoạt cơ chế kiểm tra sâu hơn ở không gian
...
\section{Tầm quan trọng của nghiên cứu}
