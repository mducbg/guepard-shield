...
\subsection{Không gian và Lớp giám sát (Monitor Layer)}
...
\subsection{Mô hình đe dọa (Threat Model)}
...
\subsection{Giới hạn ngoài phạm vi (Out of Scope)}
