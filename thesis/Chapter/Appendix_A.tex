...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth]{Figure/IoT.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Figure/Bia.PNG}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Figure/GayBia.PNG}
\caption{Qui cách đóng quyển đồ án}
\label{fig:GayBia}
\end{figure} 
