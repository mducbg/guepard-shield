...
\usepackage{subfiles} % Chèn các file nhỏ, giúp chia các chapter ra
% nhiều file hơn
...
% \usepackage[natbib,backend=biber,style=ieee]{biblatex} % Giúp chèn
% tài liệu tham khảo
...
\def \TITLE{THE MASTER THESIS}
\def \AUTHOR{Nguyễn Minh Đức}

% ===================================================
\titleformat{\chapter}[hang]{\centering\bfseries}{CHAPTER
\thechapter.\ }{0pt}{}[]
...
\usepackage[all]{hypcap} % Cho phép tham chiếu chính xác đến hình ảnh
% và bảng biểu
